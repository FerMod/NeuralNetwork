...
static const std::string TRAINING_FILENAME = "trainingData.txt";
static const std::string STATE_FILENAME = "NeuralNetworkStateTest.json";

static const int TRAINING_SETS = 100;
...
int main() {
	...
	NetState state("output");
	NeuralNet net;

#if defined(CREATE_FILE) || defined(TRAIN)
	TrainingData trainingData(TRAINING_FILENAME);
#endif
